...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeInvertedRotary:
        {
            ...
            if (_vertical)
            {
                return CATransform3DTranslate(transform, 0.0, radius * sinAngle, radius * cos(angle) - radius);
            }
            else
            {
                return CATransform3DTranslate(transform, radius * sinAngle, 0.0, radius * cos(angle) - radius);
            }
        }
        case iCarouselTypeCylinder:
        case iCarouselTypeInvertedCylinder:
